/* jQuery Bracket | Copyright (c) Teijo Laine 2011-2015 | Licenced under the MIT licence */ ! function(a) {
    function b(a) {
                    ...
                    if (o.setAlignCb(y(o.el.find(".teamContainer"), o)), m) o.connectorCb(function() {
                        ...
                        var p = i % 2 === 0 ? function(a, b) {
                            var c = a.height() / 4,
                                d = 0,
                                e = 0;
                            return 0 === b.winner().id ? e = c : 1 === b.winner().id ? (d = 2 * -c, e = c) : e = 2 * c, { height: d, shift: e }
                        } : null;
                        o.connectorCb(p)
                    }
                }
    ...
    function q(a, b, c, d, e, f) {
        ...
        b["final"]().connectorCb(function(a) {
            var d, e, f = a.height() / 4,
                ...
                h = g - b.el.height() / 2;
            return 0 === b.winner().id ? (e = h + 2 * f, d = f) : 1 === b.winner().id ? (e = h, d = 3 * f) : (e = h + f, d = 2 * f), e -= a.height() / 2, { height: e, shift: d }
    ...
    function r(b, c, d, e, f, g) {
        ...
        return {
            ...
            render: function() { i.empty(), ("function" != typeof f || f()) && (i.appendTo(b.el), a.each(h, function(a, b) { b.render() })) },
            results: function() {
                var b = [];
        ...
        z = function(e) {
            ...
            function i(c, d, i, j, k) {
                function l(c, d, i, points) {
                    ...
                    if (points !=undefined && typeof points =='string') {
                        var str_array = points.split(',');

                        for (var i = str_array.length-1; i >=0 ; i--) {
                            a('<div class="score">' + str_array[i] + '</div>').appendTo(p);
                        }
                    }
                    return 0 === c && p.attr("data-resultid", "team-" + j), e.decorator.render(q, o, l), b(d.idx) && p.attr("data-teamid", d.idx), null === d.name ? p.addClass("na") : g(m).name === d.name ? p.addClass("win") : h(m).name === d.name && p.addClass("lose"), null !== d.name && i && e.save && e.save && (q.addClass("editable"), q.click(function() {
                        function b() {
                            function h(h, i) {
                ...
                return m.a.id = 0, m.b.id = 1, m.a.name = m.a.source().name, m.b.name = m.b.source().name, m.a.score = j ? j[0] : null, m.b.score = j ? j[1] : null, m.a.name && m.b.name || !b(m.a.score) && !b(m.b.score) || (console.log("ERROR IN SCORE DATA: " + m.a.source().name + ": " + m.a.score + ", " + m.b.source().name + ": " + m.b.score), m.a.score = m.b.score = null), {
                    ...
                    render: function() {
                        ...
                        s.append(l(c.id, m.a, a, u)), s.append(l(c.id, m.b, a, u1)), q.appendTo(c.el), q.append(s), this.el.css("height", c.bracket.el.height() / c.size() + "px"), s.css("top", this.el.height() / 2 - s.height() / 2 + "px"), null !== p && p(s);
